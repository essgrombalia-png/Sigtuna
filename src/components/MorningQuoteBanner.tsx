...
export const MorningQuoteBanner: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-2">
      <div className="flex items-center justify-between gap-3 px-3.5 py-1.5 sm:py-2 rounded-2xl bg-gradient-to-r from-amber-500/10 via-emerald-500/10 to-teal-500/10 dark:from-amber-400/10 dark:via-emerald-400/10 dark:to-teal-400/10 border border-emerald-500/20 dark:border-emerald-500/20 backdrop-blur-sm shadow-xs transition-all">
        <div className="flex items-center gap-2 flex-1 min-w-0">
          <span className="p-1 rounded-lg bg-emerald-500/15 text-emerald-700 dark:text-emerald-300 shrink-0">
        ...
        <button
          ...
          className="shrink-0 p-1.5 rounded-lg text-slate-500 hover:text-emerald-600 dark:text-slate-400 dark:hover:text-emerald-400 hover:bg-emerald-500/15 transition-all active:rotate-180"
        >
